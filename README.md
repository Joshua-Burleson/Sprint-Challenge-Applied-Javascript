...
1. What is the DOM?
    * The DOM is the Document Object Model, which is a language-agnostic API for programmatic access to, and manipulation of, the contents of a web page.

2. What is an event?
    * An event is a happening or action that takes place on a web-page, network, or browser (in our context). Some examples include:
        * A click of a mouse
        * A window being resized
        * A server response from an AJAX/XMLHttpRequest
        * Keyboard input

3. What is an event listener?
    * An event listener is an asynchronous function which is set to "listen" for an event in the given context and handle and/or respond to said event.
...
* [x] If you complete the Carousel, add functionality so that the carousel slides when the buttons are pressed instead of just appearing. (this, final, stretch goal completed after 7pm PST submission)
